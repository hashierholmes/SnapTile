...
/**
 * Reusable toolbar + drawing canvas overlay.
 *
 * Top bar (always visible, outside the screenshot area):
 *   [Save]  [<] [>]  [Brush icon]  [color swatches]
 *
 * The drawing canvas sits on top of the image view and intercepts
 * touches only when paint mode is active.
 */
